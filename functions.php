...
add_action( 'wp_enqueue_scripts', 'bm_enqueue_style' );
...
function bm_widgets_init() {
     ...
     register_sidebar( array(
         'name'          => __( 'Right Sidebar Widget Area', 'bm' ),
         'id'            => 'right-sidebar',
         'description'   => __( 'Appears on the right side of the blog index.', 'bm' ),
